    ...
    <div class="page-header-inner col-12">
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav float-right">
                <li class="dropdown">
                    <a class="dropdown-toggle dropdown-header-name" style="padding-right: 10px" href="#" target="_blank"><i class="fa fa-globe"></i> <span class="d-none d-sm-inline">Xem trang ngoài</span> </a>
                </li>
