					...
					<tbody>
						...
						<tr>
							...
							<td class="jsgrid-cell jsgrid-control-field jsgrid-align-center " style="width: 50px;">
								<a href="{{URL::route('deleteUser',[$us->id])}}" onclick="return confirmDelete('Bạn có chắc chắn muốn xóa người dùng này không?')"><button class="jsgrid-button jsgrid-edit-button ti-trash" type="button" title="Delete" ></button></a>
